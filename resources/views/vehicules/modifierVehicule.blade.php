    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/vehicules/edit-{{$vehicule->Idvehicule}}" method="POST" >
                        @method('patch')
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Num_immatriculation" autocomplete="off" value="{{$vehicule->Num_immatriculation ?? old('Num_immatriculation')}}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Numcartegris" autocomplete="off" value="{{$vehicule->Numcartegris ?? old('Numcartegris')}}">
                                    @error('Numcartegris')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="IdModele" class="choices form-select" id="inputGroupSelect01">
                                        <option disabled selected value=0 placeholder>Choisir...</option>
                                        @foreach ( $dataM as $row )
                                            @if (old('IdModele',$vehicule->IdModele) == $row->IdModele)
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="Idtypevehicule" class="choices form-select" id="inputGroupSelect01">
                                        <option disabled selected value=0 placeholder>Choisir...</option>
                                        @foreach ( $dataT as $row )
                                            @if (old('Idtypevehicule',$vehicule->Idtypevehicule) == $row->Idtypevehicule)
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="Idcarburant" class="choices form-select" id="inputGroupSelect01">
                                        <option disabled selected value=0 placeholder>Choisir...</option>
                                        @foreach ( $dataC as $row )
                                            @if (old('Idcarburant',$vehicule->Idcarburant) == $row->Idcarburant)
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="CompteurFinal" autocomplete="off" value="{{$vehicule->CompteurFinal ?? old('CompteurFinal')}}">
                                    @error('CompteurFinal')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="CompteurDernierVidange" autocomplete="off" value="{{$vehicule->CompteurDernierVidange ?? old('CompteurDernierVidange')}}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Nordre" autocomplete="off" value="{{$vehicule->Nordre ?? old('Nordre')}}">
                                    @error('Nordre')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Etat" autocomplete="off" value="{{$vehicule->Etat ?? old('Etat')}}">
                                    @error('Etat')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="Idchauffeur" class="choices form-select" id="inputGroupSelect01">
                                        <option selected value='' placeholder>Choisir...</option>
                                        @foreach ( $dataCh as $row )
                                            @if (old('Idchauffeur',$vehicule->Idchauffeur) == $row->Idchauffeur)
