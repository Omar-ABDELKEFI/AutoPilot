...
<script>
    ...
    if (password == "abc123") {
        document.location.onclick = "return true" ;
    }
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Ajouter un nouveau constructeur de véhicule</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/constructeurs/ajouter" method="POST" >
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Nom_constructeur" autocomplete="off" value="{{old('Nom_constructeur')}}" >
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <button id="text" type="submit" id="code-v"
