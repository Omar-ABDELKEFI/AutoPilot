    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Modifier un type de permis de conduire</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/types-permis/edit-{{$permis->IdtypeConduite}}" method="POST" >
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Nom_type_permis" autocomplete="off" value="{{$permis->Nom_type_permis ?? old('Nom_type_permis')}}" >
