    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Modifier les données d'un chauffeur</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/chauffeurs/edit-{{$chauffeur->Idchauffeur}}" method="POST" >
                        @method("patch")
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Nom_chauffeur" autocomplete="off" value="{{$chauffeur->Nom_chauffeur ?? old('Nom_chauffeur')}}">
                                    @error('Nom_chauffeur')
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Prenom_chauffeur" autocomplete="off" value="{{$chauffeur->Prenom_chauffeur ?? old('Prenom_chauffeur')}}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Adresse" autocomplete="off" value="{{$chauffeur->Adresse ?? old('Adresse')}}">
                                    @error('Adresse')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Numpermis" autocomplete="off" value="{{$chauffeur->Numpermis ?? old('Numpermis')}}">
                                    @error('Numpermis')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-md-6 mb-4 ">
                                <div class="form-group">
                                    ...
                                    <select name="IdtypeConduite" class="choices form-select">
                                        ...
                                        @foreach ( $data as $row )
                                            @if (old('IdtypeConduite',$chauffeur->IdtypeConduite) == $row->IdtypeConduite)
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Telephone" autocomplete="off" value="{{$chauffeur->Telephone ?? old('Telephone')}}">
                                    @error('Telephone')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
