    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Modifier un voyage </h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/voyages/edit-{{$voyage->IdVoyage}}" method="POST" >
                        @method('PATCH')
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="Idchauffeur" class="choices form-select">
                                        ...
                                        @foreach ( $dataC as $row )
                                            @if (old('Idchauffeur',$voyage->Idchauffeur) == $row->Idchauffeur)
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="Idvehicule" class="choices form-select">
                                        ...
                                        @foreach ( $dataV as $row )
                                            @if (old('Idvehicule',$voyage->Idvehicule) == $row->Idvehicule)
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="start" name="Datedepart" 
                                        max="{{Carbon\Carbon::now()->toDateString()}}" value="{{$voyage->Datedepart ?? old('Datedepart')}}">
                                    @error('Datedepart')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                                ...
                                <div class="form-group">
                                    <label for="last-name-column">Heure depart</label>
                                     <input class="form-control" type="time" 
                                        name="Heuredepart" step="2" required value="{{$voyage->Heuredepart ?? old('Heuredepart')}}">
                                    @error('Heuredepart')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="start" name="Datearrivee" 
                                        max="{{Carbon\Carbon::now()->toDateString()}}" value="{{$voyage->Datearrivee ?? old('Datearrivee')}}">
                                    @error('Datearrivee')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="time" 
                                        name="Heurearrivee" step="2" required value="{{$voyage->Heurearrivee ?? old('Heurearrivee')}}">
                                    @error('Heurearrivee')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="CompteurDepart" autocomplete="off" value="{{$voyage->CompteurDepart ?? old('CompteurDepart')}}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Compteurarrivee" autocomplete="off" value="{{$voyage->Compteurarrivee ?? old('Compteurarrivee')}}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Quantitecarburant" autocomplete="off" value="{{$voyage->Quantitecarburant ?? old('Quantitecarburant')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="Iddestination" class="choices form-select">
                                        ...
                                        @foreach ( $dataD as $row )
                                            @if (old('Iddestination',$voyage->Iddestination) == $row->Iddestination)
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Prime" autocomplete="off" value="{{$voyage->Prime ?? old('Prime')}}">
                                    @error('Prime')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
