...
<div class="row match-height">
    <div class="col-12">
        <a href="/factures" class="btn btn-info">Retour</a>
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/factures/edit-{{$facture->IdFacture}}" method="POST" >
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="Idcarte" class="choices form-select">
                                        ...
                                        @foreach ( $data as $row )
                                            @if (old('Idcarte',$facture->Idcarte) == $row->Idcarte)
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="start" name="DateConsommation" 
                                        max="{{Carbon\Carbon::now()->toDateString()}}" value="{{$facture->DateConsommation ?? old('DateConsommation')}}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="time" 
                                        name="HeureConsommation" step="2" required value="{{$facture->HeureConsommation ?? old('HeureConsommation')}}" >
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="CompteurInitial" autocomplete="off" value="{{$facture->CompteurInitial ?? old('CompteurInitial')}}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="CompteurFinal" autocomplete="off" value="{{$facture->CompteurFinal ?? old('CompteurFinal')}}">
                                    @error('CompteurFinal')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="QuantiteCarburant" autocomplete="off" value="{{$facture->QuantiteCarburant ?? old('QuantiteCarburant')}}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Prixuni" autocomplete="off" value="{{$facture->Prixuni ?? old('Prixuni')}}">
                                    @error('Prixuni')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
