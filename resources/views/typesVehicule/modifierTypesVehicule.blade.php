    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/types-vehicule/edit-{{$typeVehicule->Idtypevehicule}}" method="POST" >
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Nomtypevehicule" autocomplete="off" value="{{$typeVehicule->Nomtypevehicule ?? old('Nomtypevehicule')}}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Coefficientconskm" autocomplete="off" value="{{$typeVehicule->Coefficientconskm ?? old('Coefficientconskm')}}">
