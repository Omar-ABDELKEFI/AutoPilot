    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/destinations/edit-{{$destination->Iddestination}}" method="POST" >
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Nom_destination" autocomplete="off" value="{{$destination->Nom_destination ?? old('Nom_destination')}}" >
