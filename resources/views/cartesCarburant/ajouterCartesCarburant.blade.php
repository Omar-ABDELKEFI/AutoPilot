    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/cartes-carburant/ajouter" method="POST" >
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Numcarte" autocomplete="off" value="{{old('Numcarte')}}">
                                    @error('Numcarte')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="IdFournisseur" class="choices form-select">
                                        ...
                                        @foreach ( $dataF as $row )
                                            @if (old('IdFournisseur') == $row->IdFournisseur)
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-column" class="form-control"
                                        placeholder="" name="Typecarte" autocomplete="off" value="{{old('Typecarte')}}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
