    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form" action="/modeles/edit-{{ $modele->IdModele }}" method="POST" >
                        @method('patch')
                        <div class="row">
                            <div class="col-md-6 mb-4 ">
                                <div class="form-group">
                                    ...
                                    <select name="Idconstructeur" class="choices form-select">
                                        ...
                                        @foreach ( $data as $row )
                                            @if (old('Idconstructeur',$modele->Idconstructeur) == $row->Idconstructeur)
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last-name-column" class="form-control"
                                        placeholder="" name="Nom_Modele" autocomplete="off" value="{{$modele->Nom_Modele ?? old('Nom_Modele')}}">
                                    @error('Nom_Modele')
                                        <div class="invalid-feedback" style="display: contents">
                                            <i class="bx bx-radio-circle"></i>
                                            {{$message}}
